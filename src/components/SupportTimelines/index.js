...
export default function SupportTimelines() {
  return (
    <div>
      <table className={styles.support_timelines}>
        <thead>
          <tr>
            <th>Release</th>
            <th>Patch</th>
      ...
      <div>
        ...
        <div className={styles.legend_item}>
          <span className={styles.supported_legend}></span>Latest Release, fully supported
        </div>
        <div className={styles.legend_item}>
          <span className={styles.unsupported_legend}></span>Old Release, unsupported
        </div>
      </div>
    </div>
  );
