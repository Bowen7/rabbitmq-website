            ...
            <div className={styles.flex_columns}>
              <section>
                ...
                <p>
                  ...
                  , it’s backed by a vibrant global community. Dive in with our easy-to-use <Link to="/docs">docs</Link> or <Link to="/github">contribute</Link> to shape its future!</p>
              </section>
              <section>
                ...
                <div className={styles.comparison_link}>
                  <Link to="/licensing#comparison">See how Tanzu RabbitMQ compares to Open Source</Link>
                </div>
                <div>
